...
// sanstore .xlsx files already generated in ./out, so they land in the live
// catalog without a manual admin-panel upload.
...
const PLAN = [
  { file: 'sanstore-smesiteli.xlsx', category: 'смесители', title: 'Смесители' },
  { file: 'sanstore-installyatsii.xlsx', category: 'инсталляции', title: 'Инсталляции' }
];
